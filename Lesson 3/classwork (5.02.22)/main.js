...
//     document.write(`<div class="xxx"> ${simpson.name}${simpson.surname} <br/> Вік - ${simpson.age} років <br/>  ${simpson.info} <img src="${simpson.photo}" alt=""> </div>>`)
// }
// document.write(`</div>`)
